  ...
  sections: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          location: "Gurgaon, HR, India",
          description:
            "Contributed to the development and maintenance of automated test suites for gaming applications using Selenium WebDriver and Java. Collaborated with cross-functional teams to define test strategies and ensure comprehensive test coverage. Participated in code reviews and provided feedback on test automation best practices. Assisted in the integration of automated tests into CI/CD pipelines using Jenkins.",
          color: "#0879bf",
        },
    ...
    {
      title: "Internships and Research Assistantships",
      experiences: [
        {
           title: "ML Engineer",
