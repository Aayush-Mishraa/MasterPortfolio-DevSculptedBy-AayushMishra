# 🚀 MasterPortfolio - DevSculptedBy AayushMishra

> **Professional portfolio showcasing QA Automation Engineering & Full Stack Development expertise!**

[![React](https://img.shields.io/badge/React-18.2.0-61DAFB?style=flat-square&logo=react)](https://reactjs.org/)
[![Node.js](https://img.shields.io/badge/Node.js-20.11.1-339933?style=flat-square&logo=node.js)](https://nodejs.org/)
[![Build Status](https://img.shields.io/github/actions/workflow/status/Aayush-Mishraa/MasterPortfolio-DevSculptedBy-AayushMishra/deploy-ftp.yml?style=flat-square)](https://github.com/Aayush-Mishraa/MasterPortfolio-DevSculptedBy-AayushMishra/actions)
[![Website](https://img.shields.io/website?url=https%3A//aayushmishra.tech&style=flat-square)](https://aayushmishra.tech)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)

## ✨ **Live Demo**
🌐 **[Visit Portfolio](https://aayushmishra.tech)**
...
- ✅ **Premium UI** - CreativeFooter with automation tools showcase
- ✅ **Fast Loading** - Optimized build, lazy loading
...
## 🔧 **Deployment**
This portfolio uses **GitHub Actions** for automatic deployment to **Hostinger**:
- **Push to main** → Auto-build → Auto-deploy
- **Zero downtime** deployments
- **Environment protection** with manual approval option
...
## 🎨 **Customization**
1. **Portfolio Data**: Edit `src/portfolio.js`
2. **Themes**: Modify `src/theme.js`
3. **Components**: Update files in `src/components/`
4. **Styling**: CSS files in respective component folders

## 📝 **License**
MIT © 2025 **Aayush Mishra**
...
## 💬 **Contact**
- **Website**: [aayushmishra.tech](https://aayushmishra.tech)
- **GitHub**: [@Aayush-Mishraa](https://github.com/Aayush-Mishraa)
...
=======
# MasterPortfolio-DevSculptedBy-AayushMishra
>>>>>>> 11a266feff506927bc7cd912a935d8644040a1d1
